...
9 	1)Можливість збільшення числа віддалених взаємодіючих користувачів, що
	 виконують функції збору, обробки, зберігання та передачі інформації;
 	2)Зняття пікових навантажень з централізованої бази шляхом розподілу обробки
	 і зберігання локальних баз на різних персональних комп'ютерах;
